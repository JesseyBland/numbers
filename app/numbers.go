...
//Numbers Origin number is fed in and cnum is returned
func Numbers(number int) string {

	//Varriables for each digit in 9999 cnumb
	var n1000 string
	var n100 string
	var n10 string
	var n1 string
	...
	//logic strings used to set quardrant variations and make the string graph
	var (
		qq1 Quad
		qq2 Quad
		qq3 Quad
	...
	//Cnumber Formatted return string
	var retstr string

	//Pulls the digits apart based off number value
